        ...
        <div class="mt-6 grid gap-6 lg:grid-cols-2">
            <form method="POST" action="{{ route('contact.submit') }}" class="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-slate-900">E-posta ile İletişim</h2>
                    <span class="rounded-full bg-cyan-50 px-3 py-1 text-xs font-medium text-cyan-700">Resmi Kanal</span>
                </div>

                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label for="first_name" class="mb-1 block text-sm font-medium text-slate-700">Ad</label>
                    ...
                    <div>
                        <label for="last_name" class="mb-1 block text-sm font-medium text-slate-700">Soyad</label>
                ...
                <div>
                    <label for="message" class="mb-1 block text-sm font-medium text-slate-700">Mesajınız</label>
            ...
            <form
                ...
                @submit.prevent="
                    const text = `Merhaba Birlikte Kardeşlik Derneği,%0A%0A` +
                        `Ad Soyad: ${first_name} ${last_name}%0A` +
                        `E-posta: ${email}%0A%0A` +
                        `Mesaj:%0A${message}%0A%0A` +
            ...
            >
                ...
                <p class="text-sm text-slate-600">
                    Formu doldurup gönder dediğinizde mesajınız düzenli bir formatta WhatsApp üzerinden dernek hattına iletilir.
                </p>

                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        <label for="wa_first_name" class="mb-1 block text-sm font-medium text-slate-700">Ad</label>
                    ...
                    <div>
                        <label for="wa_last_name" class="mb-1 block text-sm font-medium text-slate-700">Soyad</label>
                ...
                <div>
                    <label for="wa_email" class="mb-1 block text-sm font-medium text-slate-700">E-posta</label>
                ...
                <div>
                    <label for="wa_message" class="mb-1 block text-sm font-medium text-slate-700">Mesajınız</label>
